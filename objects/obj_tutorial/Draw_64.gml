...
if (instance_exists(obj_player)) {
	...
	draw_text( view_wport[0]/2, view_yport[0] +view_hport[0]/4, "Hide behind objects by holding 'H'.");
	}
	
	//Attack
	else if (pressedHide ==true && pressedAttack == false) {
	draw_text( view_wport[0]/2, view_yport[0] +view_hport[0]/4, "Pressing 'E' allows you to attack monsters, inspect objects,"
